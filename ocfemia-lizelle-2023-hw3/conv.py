...
if __name__ == "__main__":
    ...
    for i in bar:
        ...
        if i % refresh_rate == (refresh_rate - 1):
            ...
            if accuracy >= .955:
                with open('acc_loss_config.txt', 'w') as f:
...
# TRAINING: 
#       Accuracy: 97%, Steps Required: 174, Loss: 0.12450236082077026
# VALIDATION: 
#       Using Training config: Accuracy: 96%. Steps Required: 184, Loss: 0.15900187194347382
#       After Tuning: 
# TEST: 
